...
"""
DEF_DC = [
[ 55, 45, 45, 12, 10,  5,  5,  1,  1,  1,  5]
[(0,65),(0,55),(0,55),(85,18),(80,15),(55,8),(30,5),(20,1),(20,1),(10,1),(55,5)]
[ 65, 55, 55, 18, 15,  8,  5,  1,  1,  1,  5]



]
DEF_DCI = ["Infantry", "Mech", "Bike", "Recon", "Flare", "Tank", "MdTank", "Supporter???", "NeoTank", "MegaTank", "AntiAir", "Missiles", "Artillery", "SmallCannon???", "AntiTank", "Rockets", "ExtremeRanger???", "ArmedTransport???", "Rig", "DefenseWall???", "MiniBoat???", "Lander", "TorpedoLauncher???", "Cruiser", "SUB", "BigCruiser???", "Battleship", "Carrier", "TransCopter", "BattleCopter", "ReconPlane???", "Chaser???", "Bomber", "Fighter", "SeaPlane", "Stealth"]
DEF_MC = [
	[ 1, 1, 1, 2, 1,-1,-1, 1] #Plains
	[ 1, 1, 1, 1, 1,-1,-1, 1] #Road
	[ 1, 1, 1, 1, 1, 1, 1, 1] #Bridge
	[ 2, 1,-1,-1,-1,-1,-1, 1] #River
	[ 1, 1, 2, 3, 3,-1,-1, 1] #Forest
	[ 2, 1,-1,-1,-1,-1,-1, 1] #Mountain
	[ 1, 1, 1, 2, 1,-1,-1, 1] #Ruins
	[ 1, 1, 2, 3, 3,-1,-1, 1] #WasteLand
	[ 1, 1, 1, 1, 1,-1,-1, 1] #City
	[ 1, 1, 1, 1, 1,-1,-1, 1] #Factory
	[ 1, 1, 1, 1, 1, 1, 1, 1] #Port
	[ 1, 1, 1, 1, 1,-1,-1, 1] #Airport
	[ 1, 1, 1, 1, 1, 1, 1, 1] #TempPort
	[ 1, 1, 1, 1, 1,-1,-1, 1] #TempAirport
	[ 1, 1, 1, 1, 1,-1,-1, 1] #ComTower
	[ 1, 1, 1, 1, 1,-1,-1, 1] #Radar
	[ 1, 1, 1, 1, 1,-1,-1, 1] #HQ
	[ 1, 1, 1, 1, 1,-1,-1, 1] #Silo
	[ 1, 1, 1, 2, 2,-1, 1, 1] #Beach
	[-1,-1,-1,-1,-1, 1, 1, 1] #Sea
	[-1,-1,-1,-1,-1, 1, 1, 1] #SeaFog
	[-1,-1,-1,-1,-1, 2, 2, 1] #RoughSea
	[-1,-1,-1,-1,-1, 2, 2, 1] #Reef
	[-1,-1,-1,-1,-1,-1,-1, 1] #Air
	]
DEF_MCI = ["Plains", "Road", "Bridge", "River", "Forest", "Mountain", "Ruins", "WasteLand", "City", "Factory", "Port", "Airport", "TempPort", "TempAirport", "ComTower", "Radar", "HQ", "Silo", "Beach", "Sea", "SeaFog", "RoughSea", "Reef", "Air"]
DEF_MTL = ["Infantry", "Mech", "Tread", "WheelA", "WheelB", "Boat", "TransBoat", "Plane"]

TERRAIN_ALIASES = {"Properties" : ["City", "Factory", "Port", "Airport", "ComTower", "Radar", "HQ"],
		"TempProperties" : ["TempPort", "TempAirport"],
		"Buildable" : ["Factory", "Port", "Airport"],
		"Hideable" : ["Forest", "Ruins", "City", "Factory", "Port", "Airport", "TempPort", 					"TempAirport", "ComTower", "Radar", "HQ", "SeaFog", "Reef"]}

UNIT_ALIASES = {"LandUnits" : ["Infantry", "Mech", "Bike", "Recon", "Flare", "Tank", "MdTank", 	"Supporter???", "NeoTank", "MegaTank", "AntiAir", "Missiles", "Artillery", "SmallCannon???", "AntiTank", "Rockets", "ExtremeRanger???", "ArmedTransport???", "Rig", "DefenseWall???"],
		"NavalUnits" : ["MiniBoat???", "Lander", "TorpedoLauncher???", "Cruiser", "SUB", "BigCruiser???", "Battleship", "Carrier"],
		"AirUnits" : ["TransCopter", "BattleCopter", "ReconPlane???", "Chaser???", "Bomber", "Fighter", "SeaPlane", "Stealth"],
		"DirectUnits" : ["Infantry", "Mech", "Bike", "Recon", "Flare", "Tank", "MdTank", "Supporter???", "NeoTank", "MegaTank", "AntiAir", "ArmedTransport???", "DefenseWall???", "MiniBoat???", "Cruiser", "SUB", "Carrier", "BattleCopter", "ReconPlane???", "Chaser???", "Bomber", "Fighter", "SeaPlane", "Stealth"],
		"IndirectUnits" : ["Missiles", "Artillery", "SmallCannon???", "AntiTank", "Rockets", "ExtremeRanger???","TorpedoLauncher???", "BigCruiser???", "Battleship"],
		"DirectLandUnits" : ["Infantry", "Mech", "Bike", "Recon", "Flare", "Tank", "MdTank", "Supporter???", "NeoTank", "MegaTank", "AntiAir", "ArmedTransport???", "DefenseWall???"],
		"IndirectLandUnits" : ["Missiles", "Artillery", "SmallCannon???", "AntiTank", "Rockets", "ExtremeRanger???"],
		"TransportUnits" : ["ArmedTransport???", "Rig", "MiniBoat???", "Lander", "Cruiser", "Carrier", "TransCopter"]}

CLIMATES = ["Sun", "Rain", "Storm", "Snow", "Wind"]
